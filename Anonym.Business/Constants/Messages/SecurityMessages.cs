...
namespace Anonym.Business.Constants.Messages
{
    public static class SecurityMessages
    {
        ...
        public static string ForgettingPasswordEmailSuccessful = "Şifrenizi sıfırlamak için e-posta adresinize bir bağlantı gönderildi. Lütfen e-posta adresinizi kontrol ediniz.";
        ...
        public static string PasswordHasBeenReset = "Şifreniz sıfırlandı. Şimdi giriş ekrarnından oturum açabilirsiniz.";
        ...
        public static string TokenHasExpiredForPasswordReset = "Bu bağlantının süresi dolmuş lütfen yeniniden şifre sıfırlama talebinde bulununuz.";
